...
const FooterNav = () => {
  return (
      ...
      <div className="container-fluid">
        <div className="collapse navbar-collapse  justify-content-center" id="navbarNav">
          ...
          <li className="nav-item">
            ...
            <li className="nav-item">
              <a className="nav-link" href="https://x.com/prashanttdl02k?t=fUaTitnsQHf5bU8ihU_kdg&s=09">
            ...
            <li className="nav-item">
              <a className="nav-link" href="https://www.facebook.com/prashant.rathore.1650">
                <img src='https://upload.wikimedia.org/wikipedia/commons/6/6c/Facebook_Logo_2023.png' width={30}/>
              </a>
            </li>

            <li className="nav-item">
              <a className="nav-link" href="https://www.instagram.com/yantrik_abhiyanta?igsh=MTI3aGUzMGEwdjl4Zg==">
    ...
    <p>
    © Copyright Shri Saibaba Sansthan Trust,Shirdi Tal-Rahata Dist-Ahmednagar Pin Code-423109 (Maharashtra) India.
    </p>
    </div>
    </div>
  );
