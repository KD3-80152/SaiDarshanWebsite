...
class UserEntityDaoTest {
	...
	void testAddUsers() {
		...
		List<UserEntity> list = List.of(
				...
				new UserEntity("Himanshu", "Rathore", "himanshu@gmail.com", enc.encode("himanshu"), "9465823454",UserRole.ROLE_USER,LocalDate.parse("1999-08-04"),Gender.FEMALE,"146372983567"));
